...
usage() {
  cat <<'EOF'
Usage:
  scripts/run_distill_convnextv2_nano_vit7b_1gpu.sh \
    --data-root /path/to/imagenet_root \
    --data-extra /path/to/imagenet_extra \
    --teacher-ckpt /path/to/vit7b16_teacher.pth \
    --output-dir /path/to/output_dir \
    [--config-file dinov3/configs/train/distillation_convnext/convnextv2_nano_distill_vit7b16_1gpu.yaml] \
...
CONFIG_FILE="dinov3/configs/train/distillation_convnext/convnextv2_nano_distill_vit7b16_1gpu.yaml"
PYTHON_BIN=""
DATA_ROOT=""
DATA_EXTRA=""
TEACHER_CKPT=""
